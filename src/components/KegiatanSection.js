...
function KegiatanSection() {
    ...
    return (
      <section id="kegiatan" className="kegiatan-section">
        <div className="kegiatan-container">
          <h2 className="section-title">Peringatan Hari Besar Islam</h2>
  ...
  return (
    <section id="kegiatan" className="kegiatan-section">
      <div className="kegiatan-container">
        <h2 className="section-title">{kegiatan.KegiatanJudul}</h2>
        <p className="section-subtitle">{kegiatan.KegiatanDeskripsi}</p>
        <Swiper
